...
mj_macros = {
  ...
  # MathJax does not accept a user macro such as \llbracket directly after
  # \left.  Use explicit open/close atoms for the double-bracket macros.
  "IRX" => ["\\mathopen{\\unicode{x27E6}} #1 \\mathclose{\\unicode{x27E7}}", 1],
  "IRY" => ["\\mathopen{\\unicode{x27E6}} #1:#2 \\mathclose{\\unicode{x27E7}}", 2],
  "IntRange" => ["\\mathopen{\\unicode{x27E6}} #1 \\mathclose{\\unicode{x27E7}}", 1],
  "jSym" => ["\\mathopen{\\unicode{x27E6}} \\ds {#1}\\divides{#2} \\mathclose{\\unicode{x27E7}}", 2],
  "mybinom" => ["\\binom{#1}{#2}", 2],
  "xspace" => "",
