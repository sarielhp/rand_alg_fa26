...
% [UNUSED-MACRO] \providecommand{\NearNbr}{\ensuremath{\mathrm{NNbr}}}
...
% [UNUSED-MACRO] \providecommand{\IpeModeRemove}[1]{#1}
% [UNUSED-MACRO] \providecommand{\AMSMode}[1]{}
...
% [UNUSED-MACRO] \providecommand{\QuoteOpt}[2]{\Quote{#1}{#2}}
\providecommand{\Hypercube}{\EuScript{H}}
\providecommand{\emphiC}[1]{\emphic{#1}{#1}}
% [UNUSED-MACRO] \providecommand{\Func}{f}
...
% [UNUSED-MACRO] \providecommand{\BookPart}[1]{\part{#1}}
...
% [UNUSED-MACRO] \providecommand{\Here}{\typeout{LOCATION: \currfilename\space L\the\inputlineno}\xspace}
...
% [UNUSED-MACRO]       University of Illinois; 201 N. Goodwin Avenue; Urbana, IL,
% [UNUSED-MACRO]       61801, USA; {\tt sariel\atgen{}illinois.edu}; {\tt
% [UNUSED-MACRO]          \url{http://sarielhp.org/}.} #1}}
...
% [UNUSED-MACRO]    \marginnote{\includegraphics{\RootFile{figs/trash}}}
% [UNUSED-MACRO]        #1}
...
% [UNUSED-MACRO] \providecommand{\Ungor}{\"{U}ng\"{o}r\xspace}
\providecommand{\Matousek}{Matou{\v s}ek\xspace}
% [UNUSED-MACRO] \providecommand{\Gartner}{G\"{a}rtner\xspace}
% [UNUSED-MACRO] \providecommand{\Badoiu}{B\u{a}doiu\xspace}
% [UNUSED-MACRO] \providecommand{\Barany}{B{\'a}r{\'a}ny\xspace}
% [UNUSED-MACRO] \providecommand{\Bronnimann}{Br{\"o}nnimann\xspace}
% [UNUSED-MACRO] \providecommand{\Gartner}{G{\"a}rtner\xspace}
\providecommand{\Erdos}{Erd{\H o}s\xspace}
\providecommand{\Lovasz}{Lov\'asz\xspace}
% [UNUSED-MACRO] \providecommand{\Komlos}{Koml{\'o}s\xspace}
...
\providecommand{\NP}{\ComplexityClass{NP}%
   \index{NP}\xspace}
% [UNUSED-MACRO] \providecommand{\coNP}{\ComplexityClass{co-NP}\xspace}
...
% [UNUSED-MACRO]       $_\text{p\pageref{#1}}$}}
...
% [UNUSED-MACRO]    $_\text{p\pageref{exer:#1}}$}
...
% [UNUSED-MACRO]    $_\text{p\pageref{chap:#1}}$}
...
% [UNUSED-MACRO]    \IncludeGraphics[page=#3,#4]{\File{#1/#2}}%
% [UNUSED-MACRO] }

% [UNUSED-MACRO] \newcommand{\IncGraph}[2][]{
% [UNUSED-MACRO]    \IncludeGraphics[#1]{\File{#2}}
% [UNUSED-MACRO] }
...
% [UNUSED-MACRO]    \rule{2\linewidth}{0.8mm}%
% [UNUSED-MACRO] }%
...
% [UNUSED-MACRO]    \index{near neighbor!data-structure}
% [UNUSED-MACRO] }
...
% [UNUSED-MACRO]    \index{near neighbor!data-structure!interval}}
...
% [UNUSED-MACRO]   \mathrel{\tikz[baseline=-0.55ex]{%
