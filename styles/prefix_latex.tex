...
\newcommand{\exeref}[1]{\HLink{Exercise}{exer:#1}}
...
% 1. Create custom page style for chapter start pages
\makepagestyle{chapfirstpage}

\makefootrule{chapfirstpage}{\textwidth}{0.4pt}{1ex}

% 2. Define footers: {Left}{Center}{Right}
% For two-sided documents (recto/verso):
\makeoddfoot{chapfirstpage}{\footnotesize Sariel Har-Peled}{\thepage}{\today}
\makeevenfoot{chapfirstpage}{\thepage}{Sariel Har-Peled}{}

% (Leave headers empty on chapter start pages)
\makeoddhead{chapfirstpage}{}{}{}
\makeevenhead{chapfirstpage}{}{}{}

% 3. Alias 'chapter' style to use your new style
\aliaspagestyle{chapter}{chapfirstpage}
